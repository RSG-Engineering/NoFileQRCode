...
Module Module1
    Sub Main()
        ...
        ' Extract the first 8 digits of the part number from the text
        'If we do 8 instead of 6 this should cover hard and soft part numbers 
        Dim first6Digits As String = Text.Substring(0, Math.Min(8, Text.Length))
